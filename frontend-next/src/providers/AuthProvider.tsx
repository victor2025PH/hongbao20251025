...
const DEV_USERNAME = process.env.NEXT_PUBLIC_DEV_USERNAME as string | undefined
const DEV_PASSWORD = process.env.NEXT_PUBLIC_DEV_PASSWORD as string | undefined
const DEV_TG_ID = process.env.NEXT_PUBLIC_DEV_TG_ID ? Number(process.env.NEXT_PUBLIC_DEV_TG_ID) : undefined
const DEFAULT_LANG = process.env.NEXT_PUBLIC_DEFAULT_LANG as string | undefined
